...
class convNet():
    ...
    def __init__(self):
        ...
        self.W_fc1 = tf.Variable(tf.truncated_normal(([6 * 5 * 64, 512]), mean=0.0, stddev=0.01, dtype=tf.float32))
        ...
        self.cost = tf.reduce_mean(tf.square(self.clipped_delta))
