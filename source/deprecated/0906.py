...
startLearningFrame = opt.frameStartLearn
finalExplorationFrame = opt.frameFinalExp
saveDataFreq = opt.freqSaveData
saveModelFreq = opt.freqSaveModel
trainFreq = opt.freqTrain
targetUpdateFreq = opt.freqUpdate
...
initialExplorationRate = opt.expInit
finalExplorationRate = opt.expFinal
testExplorationRate = opt.expTest
